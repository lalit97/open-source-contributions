...
- [Provide error message when navigating to Not Available resources](https://github.com/WikipediaLibrary/TWLight/pull/427)
- [Add more links to activity feed](https://github.com/WikipediaLibrary/TWLight/pull/414)
- [Add 'Back-to-top' button for partners list page](https://github.com/WikipediaLibrary/TWLight/pull/410)
- [Add condition to check user is current coordinator](https://github.com/WikipediaLibrary/TWLight/pull/406)
